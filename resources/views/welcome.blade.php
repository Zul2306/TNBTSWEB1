...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('css/LPcss/bootstrap.min.css')}}">
    <!-- Themify Icons -->
    <link rel="stylesheet" href="{{asset('css/LPcss/themify-icons.css')}}">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="{{asset('css/LPcss/owl.carousel.min.css')}}">
    <!-- Main css -->
    <link href="{{asset('css/LPcss/style.css')}}" rel="stylesheet">
</head>
                    ...
                    <nav class="navbar navbar-dark navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a href="{{ route('login') }}" class="btn btn-outline-light my-3 my-sm-0 ml-lg-3">login</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
