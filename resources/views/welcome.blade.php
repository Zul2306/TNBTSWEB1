...
>>>>>>> 03222e788866783e7c90586046813e770e978fb7
        ...
        <link href="{{asset('css/stylesh.css')}}" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <style>
            ...
            .navbar.scrolled {
                background-color: rgba(44, 44, 44, 0.726) !important;
            }
            .navbar-transparent {
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-transparent" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#">TNBTS</a>
        ...
        <style>
            .masthead {
                background-image: url('{{ asset('img/IL.png') }}');
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <div class=" center-container "><img class="img-fluid" src="{{asset('img/logo.png')}}" alt="..." /></div>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Laporkan Bencana yang terjadi di sekitar anda dengan tombol dibawah ini </h2>
                        <a class="btn btn-primary" href="{{ route('login') }}">BUAT LAPORAN</a>
                    </div>
                </div>
            </div>
        </header>
